...
function PageNotFound() {
    return (
        <div className="container d-flex flex-column align-items-center mt-5">
            ...
            <Button className="mb-4" variant="contained" color="secondary" startIcon={<ArrowBackIcon />} component={Link} to="/myNoteBook" style={{ textTransform: "none", color: "White"}}>Go back to home</Button>
        </div>
    )
}
